<template>
    <md-card v-if="$permissions.includes('print dtr')">
        <md-card-header class="md-card-header">
            <h4 class="title">Mass Printing of DTR</h4>
        ...
        <md-card-content>
            <div class="md-layout">
                <div class="md-layout-item md-small-size-100 md-size-100">
                    <md-button
                        @click="massPrintEmployee = true"
                        class="md-dense md-raised md-primary"
                        style="float: right"
                        v-if="$permissions.includes('print dtr')"
                    >
                        Print DTR</md-button
                    >
                </div>
                <!-- Mass Assignment of Employee -->
                <DialogCard v-if="massPrintEmployee">
                    <section slot="header">Mass Printing of DTR</section>
                    <section slot="body">
                        <form
                            method="post"
                            @submit.prevent="validatePrintMultipleDTR()"
                        >
                            ...
                            <md-checkbox v-model="useMonth"
                                >Use Month?</md-checkbox
                            >
                            <md-field v-if="useMonth">
                            ...
                            <md-field>
                                ...
                                <md-input v-model="supervisor" required>
                                </md-input>
                            </md-field>
                            <md-button
                                type="submit"
                                class="md-primary md-dense"
                                @click="validatePrintMultipleDTR()"
                                :disabled="employeeIds === null"
                                >{{ assignBtn }}</md-button
                            >
                            <md-button
                                class="md-dense md-danger"
                                @click="massPrintEmployee = !massPrintEmployee"
                                >✕ Close</md-button
                            >
                        </form>
                    </section>
        ...
        validatePrintMultipleDTR() {
            ...
            axios
                ...
                .then((response) => {
                    ...
                    parentURL =
                        parentURL +
                        "/generate/report/2/multiple/dtr/" +
                        printToken;
