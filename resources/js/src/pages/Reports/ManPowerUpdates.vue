    ...
    <form>
        <md-card>
            ...
            <md-card-header class="md-card-header">
                <h4 class="title">Man Power Updates</h4>
            </md-card-header>
            <md-card-content>
                <div class="md-layout">
                    <div class="md-layout-item md-medium-size-100 md-size-100">
                        <form
                            method="post"
                            @submit.prevent="printManPowerUpdates"
                        >
            ...
            const options = {
                ...
                data: {
                    ...
                    model_name: {
                        ...
                        supervisor: this.supervisorPosition,
