    ...
    <div>
        ...
        <div class="md-layout">
            ...
            <div
                ...
                v-if="$permissions.includes('portal employee schedule')"
            >
                <md-card>
                    <md-card-header
            ...
            <div
                ...
                v-if="
                    ...
                    $permissions.includes('portal dtr')
                "
            >
                <md-card>
                    <md-card-header
        ...
        <div class="md-layout">
            ...
            <div
                ...
                v-if="
                    $permissions.includes('portal dtr') ||
                    $permissions.includes('searc dtr') ||
            ...
            >
                ...
                <DialogCard v-if="printDTR">
                    ...
                    <section slot="body">
                        <form method="post" @submit.prevent="generateDTR">
                            <md-field>
...
export default {
    ...
    methods: {
        ...
        async validateChangeSchedule() {
            ...
            await this.getResp(options);
            this.fireSnackbar = true;
            this.messageSnackbar = "Schedule of this employee has been updated";
            await this.getSchedule();
            this.changeSchedule();
        },
        ...
        async getSchedule() {
            const getToken = localStorage.getItem("token");
            let baseUrl = localStorage.getItem("base_url");
            baseUrl = baseUrl + "/api/employee/schedule/portal/search";
            const options = {
                method: "GET",
                url: baseUrl,
                headers: {
        ...
        async getScheduleToday() {
            const getToken = localStorage.getItem("token");
            let baseUrl = localStorage.getItem("base_url");
            baseUrl = baseUrl + "/api/employee/schedule/portal/today";
            const options = {
                method: "GET",
                url: baseUrl,
                headers: {
        ...
        async getWeeklyRecord() {
            const getToken = localStorage.getItem("token");
            let baseUrl = localStorage.getItem("base_url");
            baseUrl = baseUrl + "/api/dtr/portal/weekly";
            const options = {
                method: "GET",
                url: baseUrl,
                headers: {
        ...
        async updateTimeSheet() {
            ...
            const getToken = localStorage.getItem("token");
            let baseUrl = localStorage.getItem("base_url");
            baseUrl = baseUrl + "/api/portal/dtr/update/" + this.updateID;
        ...
        async getTimeSheetHistoryRange() {
            ...
            const getToken = localStorage.getItem("token");
            let baseUrl = localStorage.getItem("base_url");
            baseUrl = baseUrl + "/api/dtr/portal/search";
            ...
            baseUrl = baseUrl + "/api/dtr/portal/stats";
        ...
        async updateHistoryTimeSheet() {
            ...
            const getToken = localStorage.getItem("token");
            let baseUrl = localStorage.getItem("base_url");
            baseUrl = baseUrl + "/api/dtr/portal/update/" + this.updateID;
        ...
        async generateDTR() {
            ...
            axios
                ...
                .then((response) => {
                    ...
                    //New Tab to generate the PDS - Portal
                    parentURL =
                        parentURL +
                        "/generate/report/2/portal/dtr/" +
                        printToken;
        ...
        async getSpecialCode() {
            const getToken = localStorage.getItem("token");
            let baseUrl = localStorage.getItem("base_url");
            baseUrl = baseUrl + "/api/special-schedule/portal/search";
