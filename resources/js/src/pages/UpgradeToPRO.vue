            ...
            <div class="md-layout-item md-size-66 mx-auto md-small-size-100">
                <md-card>
                    <md-card-header data-background-color="purple">
                        ...
                        <p class="category">
                            Are you looking for more components? Please check
                            our Premium Version of Vue Material Dashboard.
                        </p>
                    </md-card-header>
                        ...
                        <div class="table-responsive table-upgrade">
                            <table class="table" cellspacing="0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            DataTables, VectorMap, SweetAlert,
                                            Wizard, jQueryValidation,
                                            FullCalendar etc...
                                        </td>
                                        <td class="text-center">
                                            <i
