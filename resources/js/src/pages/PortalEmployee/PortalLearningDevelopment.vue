                ...
                <div class="md-layout">
                            ...
                            >
                                ...
                                >
                                    <md-button
                                        ...
                                        @click="
                                            editLearningDevelopment(item.id)
                                        "
                                        :disabled="isUpdateEmployee === 'false'"
                                    >
                                    ...
                                    <md-button
                                        ...
                                        @click="
                                            deleteLearningDevelopment(item.id)
                                        "
                                        :disabled="isUpdateEmployee === 'false'"
                                    >
                    ...
                    <div class="md-layout-item md-size-100 text-right">
                        <!-- <md-button class="md-raised md-dense md-success"
                            ><md-icon>save</md-icon> Save Learning and
                            Development</md-button
                        > -->
                    </div>
                </div>
            </md-card-content>
...
export default {
    ...
    mixins: [userAction],
    name: "PortalLearningDevelopment",
    props: {
        dataBackgroundColor: {
            type: String,
            default: "",
    ...
    methods: {
        ...
        async validateLearningDevelopment() {
            ...
            this.baseUrl =
                this.baseUrl + "/api/employee/training/portal/create/";
        ...
        async getLearningDevelopment() {
            ...
            this.baseUrl = localStorage.getItem("base_url");
            this.baseUrl =
                this.baseUrl + "/api/employee/training/portal/search/";
        ...
        async editLearningDevelopment(id) {
            ...
            this.baseUrl = localStorage.getItem("base_url");
            this.baseUrl =
                this.baseUrl + "/api/employee/training/portal/search/" + id;
        ...
        async updateLearningDevelopment() {
            ...
            this.baseUrl =
                this.baseUrl +
                "/api/employee/training/portal/update/" +
                this.updateId;
        ...
        async deleteLearningDevelopment(id) {
            ...
            this.baseUrl = localStorage.getItem("base_url");
            this.baseUrl =
                this.baseUrl + "/api/employee/training/portal/delete/" + id;
