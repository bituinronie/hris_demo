...
export default {
    ...
    name: "PortalCivilServiceAndLicense",
    mixins: [userAction],
    props: {
        dataBackgroundColor: {
            type: String,
    ...
    data: () => ({
        ...
        form: {
            ...
            place_conferment: "Manila",
            license_number: "43892384923",
    ...
    methods: {
        ...
        async validateAddEligibility() {
            ...
            this.baseUrl =
                this.baseUrl + "/api/employee/eligibility/portal/create/";
        ...
        async getEligibilityRecord() {
            ...
            this.baseUrl = localStorage.getItem("base_url");
            this.baseUrl =
                this.baseUrl + "/api/employee/eligibility/portal/search/";
        ...
        async getParam() {
            ...
            this.baseUrl = localStorage.getItem("base_url");
            this.baseUrl =
                this.baseUrl + "/api/employee/eligibility/portal/parameter/";
            const options = {
                method: "GET",
                url: this.baseUrl,
                headers: {
        ...
        async editEligibility(id) {
            ...
            this.baseUrl = localStorage.getItem("base_url");
            this.baseUrl =
                this.baseUrl + "/api/employee/eligibility/portal/search/" + id;
        ...
        async updateEligibility() {
            ...
            this.baseUrl =
                this.baseUrl +
                "/api/employee/eligibility/portal/update/" +
                this.updateId;
        ...
        async deleteEligibility(id) {
            ...
            this.baseUrl = localStorage.getItem("base_url");
            this.baseUrl =
                this.baseUrl + "/api/employee/eligibility/portal/delete/" + id;
    ...
    async mounted() {
        ...
        this.employeeID = localStorage.getItem("accountId");
    },
};
</script>
<style scoped>
