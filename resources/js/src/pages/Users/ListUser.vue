                    ...
                    >
                        ...
                        >
                            ...
                            <md-table-cell
                                ...
                                >{{ item.employee_name }}</md-table-cell
                            >
                            <md-table-cell
                                md-label="Username"
                                md-sort-by="username"
...
export default {
    ...
    methods: {
        changeCurrentUserSelection() {
            ...
            localStorage.setItem("selection_name_users", this.selectionName);
        ...
        async getUsers() {
            ...
            this.baseUrl =
                this.baseUrl + "/api/user/search/?searchValue=" + searchValue;
        ...
        onSelect(item) {
            ...
            if (!item) {
                ...
                localStorage.setItem("full_name", item.username);
                this.isSelected = true;

                //On Employee selection
                this.selectionName = item.username;
            }
        },
    },
    async created() {
