            ...
            <md-card-content style="margin-top: 20px">
                <div class="md-layout">
                    <div class="md-layout-item md-small-size-100 md-size-50">
                        ...
                        <br />
                        <md-radio v-model="relation.ans" :value="conditionTrue">
                            Yes
                        </md-radio>
                        <md-radio
                    ...
                    <div class="md-layout-item md-small-size-100 md-size-50">
                        ...
                        offense?
                        <br />
                        <md-radio v-model="guilty.ans" :value="conditionTrue">
                            Yes
                        </md-radio>
                        <md-radio v-model="guilty.ans" :value="conditionFalse">
                            No
                        </md-radio>
                        <br />
                        <md-field>
                    ...
                    <div class="md-layout-item md-small-size-100 md-size-50">
                        ...
                        <br />
                        <md-radio v-model="charge.ans" :value="conditionTrue">
                            Yes
                        </md-radio>
                        <md-radio v-model="charge.ans" :value="conditionFalse">
                            No
                        </md-radio>
                        <br />
                        <md-field>
                ...
                <div class="md-layout">
                    ...
                    <div class="md-layout-item md-small-size-100 md-size-100">
                        ...
                        <md-autocomplete
                            ...
                            :disabled="empSelected"
                        >
                            <label>Type Memberships Here</label>
                        </md-autocomplete>
                        <md-button
                            class="md-dense"
                            @click="addMembership"
                    ...
                    >
                        <md-button
                            ...
                            :disabled="empSelected || isUpdating"
                        >
...
export default {
    ...
    methods: {
        ...
        async deleteReference(id) {
            ...
            this.baseUrl = localStorage.getItem("base_url");
            this.baseUrl =
                this.baseUrl + "/api/employee/reference/delete/" + id;
