                ...
                <div class="md-layout-item md-small-size-100 md-size-100">
                    ...
                    >
                        ...
                        <md-table-row slot="md-table-row" slot-scope="{ item }">
                            ...
                            >
                                <label
                                    v-if="item.is_government_service === true"
                                    >Yes</label
                                >
                                <label
                                    v-if="item.is_government_service === false"
                                    >No</label
                                >
                            ...
                            <md-table-cell
                                ...
                                >{{ item.status_of_appointment }}</md-table-cell
                            >
...
export default {
    ...
    methods: {
        ...
        async validateExperience() {
            ...
            this.baseUrl =
                this.baseUrl +
                "/api/employee/work-experience/create/" +
                this.empSelectionID;
        ...
        async updateExperience() {
            ...
            this.baseUrl =
                this.baseUrl +
                "/api/employee/work-experience/update/" +
                this.updateId;
        ...
        async getWorkExperiencesRecord() {
            ...
            this.baseUrl =
                this.baseUrl +
                "/api/employee/work-experience/search/" +
                this.empSelectionID;
        ...
        async getParam() {
            ...
            this.baseUrl = localStorage.getItem("base_url");
            this.baseUrl =
                this.baseUrl + "/api/employee/work-experience/parameter/";
            const options = {
                method: "GET",
                url: this.baseUrl,
                headers: {
        ...
        async deleteExperience(id) {
            ...
            this.baseUrl = localStorage.getItem("base_url");
            this.baseUrl =
                this.baseUrl + "/api/employee/work-experience/delete/" + id;
            const options = {
                method: "DELETE",
                url: this.baseUrl,
                headers: {
